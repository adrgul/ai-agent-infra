...
# Public-facing ALB for routing traffic to ECS tasks
...
resource "aws_security_group" "alb" {
  ...
  ingress {
    ...
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"]
    description = "Allow Grafana traffic from internet"
  }
...
resource "aws_lb_target_group" "grafana" {
  ...
  tags = {
    Name = "${var.project_name}-grafana-target-group"
  }
}

# -----------------------------------------------------------------------------
# ALB Listener for App (Port 80 -> 8000)
# -----------------------------------------------------------------------------
