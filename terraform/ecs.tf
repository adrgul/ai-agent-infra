...
# Runs the AI agent app with Prometheus and Grafana in a single Fargate task
...
resource "aws_security_group" "ecs_tasks" {
  ...
  # Allow inbound from ALB on port 8000 (app)
  ingress {
    from_port       = 8000
    to_port         = 8000
    protocol        = "tcp"
  ...
  # Allow inbound from ALB on port 3000 (Grafana)
  ingress {
    from_port       = 3000
    to_port         = 3000
    protocol        = "tcp"
